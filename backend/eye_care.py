...
open_threshold_duration = 3  # Time (seconds) before blinking reminder
close_threshold_duration = 3  # Time (seconds) before alarm for closed eyes
...
while True:
    ...
    if faces:
        ...
        if ratioAvg < 22.5 and counter == 0:  # Detect a blink
